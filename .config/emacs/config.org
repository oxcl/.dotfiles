...
** <escape> as cancel and C-g as goto-line
swap <escape> and C-g at lowest level (only possible in gui)
#+begin_src elisp
...
** Parenthesis and Pair Characters
#+begin_src elisp
  (electric-pair-mode)
...
#+begin_src elisp :tangle no
  (use-package lua-ts-mode
    ...
    :config
    (oxcl/add-auto-mode 'lua "\\.lua\\'" 'lua-ts-mode))
#+end_src
